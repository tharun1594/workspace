...
describe(':::RJSCP1Q3F3_TEST_SUITE_1:::Simple Todos tests', () => {
  afterEach(() => {
    console.error = originalConsoleError
  })

  it(':::RJSCP1Q3F3_TEST_1:::Page should consist of at least two HTML list items and the initialTodosList should be rendered using a unique key as a prop for each todo item:::5:::', () => {
  ...
  it(':::RJSCP1Q3F3_TEST_2:::Page should consist of HTML main heading element with text content as "Simple Todos":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCP1Q3F3_TEST_3:::Page should initially consist of HTML paragraph elements with text content as the values of the key "title" from the initialTodoList provided:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCP1Q3F3_TEST_4:::Page should initially consist of at least eight HTML button elements with text content as "Delete":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCP1Q3F3_TEST_5:::When the Delete button of a todo item is clicked, the respective todo should be deleted:::5:::', () => {
    render(<App />)
