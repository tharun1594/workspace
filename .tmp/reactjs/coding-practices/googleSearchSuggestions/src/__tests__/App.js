...
describe(':::RJSCPEAC7M_TEST_SUITE_1:::Google Search Suggestions tests', () => {
  afterEach(() => {
    console.error = originalConsoleError
  })

  it(':::RJSCPEAC7M_TEST_1:::Page should consist of at least two HTML list items and the suggestionsList should be rendered using a unique key as a prop for each suggestion item:::5:::', () => {
  ...
  it(':::RJSCPEAC7M_TEST_2:::Page should consist of HTML image element with alt attribute value as "google logo" and src attribute value as URL for google logo:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPEAC7M_TEST_3:::Page should consist of HTML image element with alt attribute value as "search icon" and src attribute value as URL for search icon:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPEAC7M_TEST_4:::Page should consist of HTML input element with type attribute value as "search":::5:::', () => {
    render(<App />)
    expect(screen.getByRole('searchbox')).toBeInTheDocument()
  })

  it(':::RJSCPEAC7M_TEST_5:::Page should consist of HTML unordered list element to display the list of suggestions received from suggestionsList:::5:::', () => {
    render(<App />)
    expect(screen.getByRole('list')).toBeInTheDocument()
    expect(screen.getByRole('list').tagName).toBe('UL')
  })

  it(':::RJSCPEAC7M_TEST_6:::Page should consist of at least six HTML list items to display the list of suggestions received from suggestionsList:::5:::', () => {
    render(<App />)
    expect(screen.getAllByRole('listitem').length).toBeGreaterThanOrEqual(6)
  })

  it(':::RJSCPEAC7M_TEST_7:::Page should initially consist of HTML paragraph elements with text content as the values of the key "suggestion" from the suggestionsList provided:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPEAC7M_TEST_8:::Page should consist of at least six HTML image elements with alt attribute value as "arrow" and src attribute value as the URL for arrow icon:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPEAC7M_TEST_9:::When a value is provided in the search input field, the suggestions should be filtered irrespective of the case:::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPEAC7M_TEST_10:::When the arrow of a suggestion is clicked, the value inside the search input should be updated to the respective suggestion that has been clicked:::5:::', () => {
    render(<App />)
    userEvent.click(
